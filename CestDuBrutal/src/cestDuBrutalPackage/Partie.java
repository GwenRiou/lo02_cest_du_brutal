 ...
 // Mise en reserve
   ...
   //Mise en zones
    ...
    public void treve() {
        ...
        System.out.println("------La partie est d'elle fini ?"+(finDePartie!=false)); // on pourra l'enlev� 
        if(finDePartie==false) {
            treve=null; // premier trucs
            System.out.println("C'est la treve ");// on pourra l'enlev�
            ...
            while (!input.equalsIgnoreCase("y")) {
                ...
                if (input=="y") {
                    Zone.initialiserZone(); // A faire � la fin de la treve
